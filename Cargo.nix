...
in
{
  ...
  workspace = {
    tiny-ram-halo2 = rustPackages.unknown.tiny-ram-halo2."0.1.0";
  };
  ...
  "git+https://github.com/zcash/halo2.git".halo2_proofs."0.1.0-beta.4" = overridableMkRustCrate (profileName: rec {
    name = "halo2_proofs";
    ...
    src = fetchCrateGit {
      ...
      name = "halo2_proofs";
      version = "0.1.0-beta.4";
      rev = "72ff677776504c288f4927a6ce8d3c273ebd588d";};
    features = builtins.concatLists [
      [ "dev-graph" ]
      [ "plotters" ]
      [ "tabbycat" ]
    ...
    dependencies = {
      ...
      tabbycat = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tabbycat."0.1.2" { inherit profileName; };
    };
  });
  ...
  "unknown".tiny-ram-halo2."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "tiny-ram-halo2";
    version = "0.1.0";
    registry = "unknown";
    src = fetchCrateLocal workspaceSrc;
    dependencies = {
      halo2_proofs = rustPackages."git+https://github.com/zcash/halo2.git".halo2_proofs."0.1.0-beta.4" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
